...
According to the author of measurements \cite{asyncPerformance_2} "\cite{asyncPerformance} "The original and flattened solutions are the fastest, as they use vanilla callbacks.
