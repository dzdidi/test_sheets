...
\include{kapitel/figo}
\include{kapitel/testing}
\include{kapitel/realTime}
\include{kapitel/async}
%\include{kapitel/oop_fp}
%\include{kapitel/requirements}
%\include{kapitel/UseCase}
%\include{kapitel/conventions}
\include{kapitel/architectureDesign}
\include{kapitel/implementationTestCoverage}
%\include{kapitel/testSheets}
%\include{kapitel/nodejs}
\include{kapitel/performance}
\include{kapitel/fits}
\include{kapitel/Limitations}
...
%\{toc}{chapter}{Appendix} %add chapter to toc
