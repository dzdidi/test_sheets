...
describe('Test coverage for makeComparisonAndWriteResult', function() {
  it('should have makeComparisonAndWriteResult function', function(done) {
    assert.equal(typeof compareAndReport.makeComparisonAndWriteResult, 'function');

    done();
  });

  it('should accept four paramters', function(done) {
    assert.equal(compareAndReport.makeComparisonAndWriteResult.length, 4);
